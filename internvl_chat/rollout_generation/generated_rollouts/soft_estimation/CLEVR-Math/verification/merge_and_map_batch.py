...
def main():
    ...
    input_folder = f"/data/users/brandon/ob1-projects/InternVL/internvl_chat/rollout_generation/generated_rollouts/soft_estimation/CLEVR-Math/final_rollout_output/{split}" # TODO: edit this
    model = os.environ.get("MODEL", "gpt-4.1-mini")
    output_dir = f"/data/users/brandon/ob1-projects/InternVL/internvl_chat/rollout_generation/generated_rollouts/soft_estimation/CLEVR-Math/verification/verification_pipeline_outputs/{model}/{split}"
