...
def main():
    ...
    output_dir = f"/data/users/brandon/ob1-projects/InternVL/internvl_chat/rollout_generation/generated_rollouts/soft_estimation/CLEVR-Math/verification/verification_pipeline_outputs/{split}"
