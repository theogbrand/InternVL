...
def main():
    ...
    input_folder = f"/data/users/brandon/ob1-projects/InternVL/internvl_chat/rollout_generation/generated_rollouts/soft_estimation/AI2D/final_rollout_output/{split}" # TODO: edit this
    model = os.environ.get("MODEL", "gpt-4.1-mini")
    output_dir = f"/data/users/brandon/ob1-projects/InternVL/internvl_chat/rollout_generation/generated_rollouts/soft_estimation/AI2D/verification/verification_pipeline_outputs/{model}/{split}"
    ...
    max_tokens_per_batch = 108_000_000
...
# ```python merge_and_map_batch.py --split="AI2D" --model="gpt-4.1-nano-3"```