...
endpoint = "https://decla-mbne4gph-southafricanorth.cognitiveservices.azure.com/"
deployment = "gpt-4.1-16"
...
class AI2D_OPEN_ANSWER_Dataset(torch.utils.data.Dataset):
    def __init__(
        self,
        data,
        sample_start_idx=0,
    ...
    def __getitem__(self, idx):
        ...
        # AI2D dataset structure: image, question, answer, uid, image_path
